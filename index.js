...
switch (platform) {
  case 'android':
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'algorithms.android-arm64.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'algorithms.android-arm-eabi.node'))
        try {
          if (localFileExisted) {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(
          join(__dirname, 'algorithms.win32-x64-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'ia32':
        localFileExisted = existsSync(
          join(__dirname, 'algorithms.win32-ia32-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'algorithms.win32-arm64-msvc.node')
        )
        try {
          if (localFileExisted) {
    ...
    break
  case 'darwin':
    localFileExisted = existsSync(join(__dirname, 'algorithms.darwin-universal.node'))
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'algorithms.darwin-x64.node'))
        try {
          if (localFileExisted) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'algorithms.darwin-arm64.node')
        )
        try {
          if (localFileExisted) {
  ...
  case 'freebsd':
    ...
    localFileExisted = existsSync(join(__dirname, 'algorithms.freebsd-x64.node'))
    try {
      if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'algorithms.linux-x64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'algorithms.linux-x64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'algorithms.linux-arm64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'algorithms.linux-arm64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm':
        localFileExisted = existsSync(
          join(__dirname, 'algorithms.linux-arm-gnueabihf.node')
        )
        try {
          if (localFileExisted) {
...
const { huffManEncode, huffManDecode } = nativeBinding

module.exports.huffManEncode = huffManEncode
module.exports.huffManDecode = huffManDecode
